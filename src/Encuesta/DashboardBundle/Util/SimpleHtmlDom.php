...
use Encuesta\DashboardBundle\Util\SimpleHtmlDomNode;
 ...
 * @package PlaceLocalInclude
 */
class SimpleHtmlDom//SimpleHtmlDom
{
	public $root = null;
	public $nodes = array();
	...
	protected $optional_closing_tags = array(
        ...
        /**
         * 
         * Funciones que estaban solas y ahora las inlcuimos dentro de la clases como estaticas
         * 
         **/
        ...
        // get html dom from file
        // $maxlen is defined in the code as PHP_STREAM_COPY_ALL which is defined as -1.
        public static function my_file_get_html($contents, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
        {
                // We DO force the tags to be terminated.
                $dom = new SimpleHtmlDom(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
                // For sourceforge users: uncomment the next line and comment the retreive_url_contents line 2 lines down if it is not already done.
